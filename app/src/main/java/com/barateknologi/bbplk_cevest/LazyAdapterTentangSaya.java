...
public class LazyAdapterTentangSaya extends BaseAdapter {
	...
	public LazyAdapterTentangSaya(Activity a, ArrayList<HashMap<String, String>> d) {
		activity = a;
		data = d;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			vi = inflater.inflate(R.layout.list_kelas, null);
