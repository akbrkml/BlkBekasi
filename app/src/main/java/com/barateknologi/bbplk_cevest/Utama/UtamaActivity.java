...
import com.barateknologi.bbplk_cevest.Utama.TabUtamaFragment;
      ...
      /*  Button btn = (Button) findViewById(R.id.btn);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //save data
                Intent i = new Intent(MainActivity.this,ProgramPelatihan.class);
                startActivity(i);
...
*/
         ...
         */
             ...
             mFragmentTransaction.replace(R.id.containerView,new TabUtamaFragment()).commit();
        /**
         ...
         */
             ...
             public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.nav_item_inbox) {
                    ...
                    xfragmentTransaction.replace(R.id.containerView,new TabUtamaFragment()).commit();
                }
