...
public class LazyAdapterTentangSaya_kelas extends BaseAdapter {
	...
	public LazyAdapterTentangSaya_kelas(Activity a, ArrayList<HashMap<String, String>> d) {
		activity = a;
		data = d;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			vi = inflater.inflate(R.layout.listtentangsaya, null);
	...
	//	idprog.setText(daftar_kelas.get(HomeFragment.TAG_IDREG));
		namaanggota.setText(daftar_kelas.get(HomeFragment.TAG_NAMA));
		namaprogram.setText(daftar_kelas.get(HomeFragment.TAG_NAMAPROG));
		imageLoader.DisplayImage(daftar_kelas.get(HomeFragment.TAG_GAMBAR), thumb_image);
		return vi;
	}
}